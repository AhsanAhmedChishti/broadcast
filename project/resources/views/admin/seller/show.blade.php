            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Customer Details') }} <a class="add-btn"
                            href="javascript:history.back();"><i class="fas fa-arrow-left"></i> Back</a></h4>
                    <ul class="links">
                        <li>
                            ...
                            <div class="order-details-table">
                                <div class="mr-table">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example2" class="table table-hover" cellspacing="0" style="width:100%;">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                @foreach ($data->orders as $order)
                                                    <tr>
                                                        <td><a
                                                                href="{{ route('admin-order-show', $order->id) }}">{{ sprintf("%'.08d", $order->id) }}</a>
                                                        </td>
                                                        <td>{{ date('Y-m-d h:i:s a', strtotime($order->created_at)) }}
                                                        </td>
                                                        <td>{{ $order->currency_sign . round($order->pay_amount, 2) }}
                                                        </td>
                                ...
                                <div class="col-md-12">
                                    <div class="contact-form">
                                        <form id="emailreply1">
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="email" readonly class="input-field eml-val" id="eml1"
                                                        name="to" placeholder="{{ __('Emai') }}l *" value=""
                                                        required="">
                                                </li>
                                                <li>
