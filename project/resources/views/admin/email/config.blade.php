                        ...
                        <div class="body-area">
                            ...
                            <form action="{{ route('admin-gs-update') }}" id="ghulamabbasform" method="POST"
                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{ route('admin-gs-issmtp', 1) }}"
                                                    {{ $gs->is_smtp == 1 ? 'selected' : '' }}>Activated</option>
                                                <option data-val="0" value="{{ route('admin-gs-issmtp', 0) }}"
                                                    {{ $gs->is_smtp == 0 ? 'selected' : '' }}>Deactivated</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="SMTP Host" name="smtp_host"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('SMTP Username') }} "
                                            name="smtp_user" value="{{ $gs->smtp_user }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('SMTP Password') }} "
                                            name="smtp_pass" value="{{ $gs->smtp_pass }}" required="">
                                    </div>
                                </div>
