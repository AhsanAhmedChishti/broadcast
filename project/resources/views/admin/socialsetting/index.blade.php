...
@section('content')
    ...
    <div class="content-area">
        ...
        <div class="social-links-area">
            ...
            <form id="ghulamabbasform" class="form-horizontal" action="{{ route('admin-social-update-all') }}"
                method="POST">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="facebook" id="facebook" placeholder="http://facebook.com/"
                            required="" type="text" value="{{ $data->facebook }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="gplus" id="gplus" placeholder="https://www.instagram.com/"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="twitter" id="twitter" placeholder="http://twitter.com/"
                            required="" type="text" value="{{ $data->twitter }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="linkedin" id="linkedin" placeholder="http://linkedin.com/"
                            required="" type="text" value="{{ $data->linkedin }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="dribble" id="dribble" placeholder="https://dribbble.com/"
                            required="" type="text" value="{{ $data->dribble }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
