...
@section('content')
    <div class="content-area">
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Edit Auction') }}<a class="add-btn"
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="ghulamabbasform" action="{{ route('admin-auction-update', $data->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select class="input-field" name="conditions" required="">
                                            ...
                                            <option value="New" {{ $data->conditions == 'New' ? 'selected' : '' }}>
                                                {{ __('New') }}</option>
                                            <option value="Used" {{ $data->conditions == 'Used' ? 'selected' : '' }}>
                                                {{ __('Used') }}</option>
                                            <option value="Recondition"
                                                {{ $data->conditions == 'Recondition' ? 'selected' : '' }}>
                                                {{ __('Recondition') }}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->photo ? asset('assets/images/auction/' . $data->photo) : asset('assets/images/noimage.png') }});">
                                                <label for="image-upload" class="img-label" id="image-label"><i
                                                        class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                                <input type="file" name="photo" class="img-upload" id="image-upload">
                                            </div>
                                            <p class="text">{{ __('Prefered Size') }}:
                                                {{ __('(600x600) or Square Sized Image') }}</p>
                                        </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <textarea class="nic-edit" name="descriptions"
                                                ...
                                                required="">{{ $data->descriptions }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="number" class="input-field" name="start_bid" id="start_bid"
                                            placeholder="{{ __('Enter Bid Amount') }}" min="0" step="0.1" required=""
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="checkbox-wrapper">
                                                    ...
                                                    <label
                                                        for="is_featured">{{ __('Add This Auction To Featured') }}</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" name="is_live" id="is_live" value="1"
                                                        {{ $data->is_live == 1 ? 'checked' : '' }}>
                                                    <label for="is_live">{{ __('Add This Auction To Live') }}</label>
                                                </div>
                                            </div>
                                        </div>
