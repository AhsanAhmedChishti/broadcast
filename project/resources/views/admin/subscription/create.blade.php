                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="ghulamabbasformdata" action="{{ route('admin-subscription-create') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="title"
                                            placeholder="Enter Subscription Title" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="currency"
                                            placeholder="Enter Subscription Currency" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="currency_code"
                                            placeholder="Enter Subscription Currency Code" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="price"
                                            placeholder="Enter Subscription Cost" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="days"
                                            placeholder="Enter Subscription Days" required="" value="">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" id="allowed_products"
                                                name="allowed_products" placeholder="Enter Allowed Products" value="">
                                        </div>
                                    </div>
                                </div>
