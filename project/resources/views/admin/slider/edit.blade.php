                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="ghulamabbasform" action="{{ route('admin-sl-update', $data->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control" name="title_text" id="title_text" rows="5"
                                                    placeholder="Enter Title Text">{{ $data->title_text }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload full-width-img">
                                            ...
                                            <p class="text">{{ __('Prefered Size') }}:
                                                {{ __('(1920x800) or Square Sized Image') }}</p>
                                        </div>
                                    ...
                                    <div class="col-lg-7">
                                        <select name="position" required="">
                                            ...
                                            <option value="slide-one"
                                                {{ $data->position == 'slide-one' ? 'selected' : '' }}>Left</option>
                                            <option value="slide-two"
                                                {{ $data->position == 'slide-two' ? 'selected' : '' }}>Center</option>
                                            <option value="slide-three"
                                                {{ $data->position == 'slide-three' ? 'selected' : '' }}>Right</option>
                                        </select>
                                    </div>
                                </div>
