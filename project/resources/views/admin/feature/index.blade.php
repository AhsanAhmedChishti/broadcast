                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="service_subtitle"
                                                value="{{ App\Models\Pagesetting::findOrFail(1)->service_subtitle }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="service_title"
                                                value="{{ App\Models\Pagesetting::findOrFail(1)->service_title }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="service_text" value=""
                                                placeholder="Enter Text"
                                                required>{{ App\Models\Pagesetting::findOrFail(1)->service_text }}</textarea>
                                        </div>
                                    </div>
