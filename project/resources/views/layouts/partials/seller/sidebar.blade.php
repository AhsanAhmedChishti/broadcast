    ...
    <div class="dashboard-widget mb-30 mb-lg-0">
        <div class="user">
            <div class="thumb-area">
                ...
                <a href="{{ route('seller.seller_profile') }}">
        ...
        <ul class="dashboard-menu" id="accordion">
            <li>
                <a href="{{ route('seller.dashboard') }}"
                    class="{{ request()->routeIs('seller.dashboard') ? 'active' : '' }}"><i
                        class="flaticon-dashboard"></i>{{ __('Dashboard') }}</a>
            </li>
            <li>
                <a href="{{ route('seller.seller_profile') }}"
                    class="{{ request()->routeIs('seller.seller_profile') ? 'active' : '' }}"><i
            ...
            <li>
                ...
                <ul class="collapse list-unstyled {{ request()->is('user/auction') || request()->is('user/auction/*') ? 'show' : '' }}"
                    ...
                    <li>
                        <a class="{{ request()->routeIs('seller-auction-index') ? 'active' : '' }}"
                            href="{{ route('seller-auction-index') }}"> {{ __('All Auctions List') }}</a>
                    </li>

                    <li>
                        <a class="{{ request()->routeIs('seller-auction-create') ? 'active' : '' }}"
                            href="{{ route('seller-auction-create') }}">{{ __('Create Auction') }}</a>
                    </li>

                    <li>
                        <a class="{{ request()->routeIs('seller-auction-pending') ? 'active' : '' }}"
                            href="{{ route('seller-auction-pending') }}"> {{ __('Pending Auctions') }}</a>
                    </li>
