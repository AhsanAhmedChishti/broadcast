...
@section('content')
    ...
    <div class="content-area">
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add New Auction') }}<a class="add-btn"
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="ghulamabbasform" action="{{ route('user-auction-store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="checkbox-wrapper">
                                            ...
                                            <label for="is_featured">{{ __('Add This Auction To Featured') }}
                                                ({{ __('Price') }}
                                                {{ $gs->currency_format == 0? $gs->currency_sign . number_format($gs->feature_price, 2, ',', '.'): number_format($gs->feature_price, 2, ',', '.') . $gs->currency_sign }})</label>
        ...
        $("#uploadgallery").change(function() {
            ...
            for (var i = 0; i < total_file; i++) {
                $('.selected-image .row').append('<div class="col-sm-6">' +
                    ...
                    '</div>' +
                    '</div> ');
                $('#auctionform').append('<input type="hidden" name="galval[]" id="galval' + i +
