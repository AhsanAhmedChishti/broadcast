...
class PaymentController extends Controller
{
 ...
 public function store(Request $request){
     ...
     $return_url = action('Seller\PaymentController@payreturn');
     $cancel_url = action('Seller\PaymentController@paycancle');
     $notify_url = action('Seller\PaymentController@notify');
