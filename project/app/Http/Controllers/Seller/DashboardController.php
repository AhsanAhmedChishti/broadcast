...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('seller.dashboard', compact('opened', 'closed'));
    }
    ...
    public function userProfileUpdate(Request $request)
    {
        ...
        if ($file = $request->file('cover_photo')) {
            ...
            if ($data->cover_photo != null) {
                if (file_exists(public_path() . '/assets/images/users/' . $data->cover_photo)) {
                    unlink(public_path() . '/assets/images/users/' . $data->cover_photo);
                }
            }
    ...
    public function passwordreset()
    {
        ...
        return view('seller.password', compact('data'));
    }
