...
class AuctionPaypalController extends Controller
{
     ...
     public function payment($id){
        ...
        return view('seller.auction.payment',compact('data'));
     }
 ...
 public function store(Request $request){
     ...
     $return_url = action('Seller\AuctionPaypalController@payreturn');
     $cancel_url = action('Seller\AuctionPaypalController@paycancle');
     $notify_url = action('Seller\AuctionPaypalController@notify');
