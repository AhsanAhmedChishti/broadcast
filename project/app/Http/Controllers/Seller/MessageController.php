   ...
   public function messages()
    {
        ...
        return view('seller.message.index',compact('user','convs'));            
    }
    ...
    public function message($id)
    {
            ...
            return view('seller.message.create',compact('user','conv'));                 
    }
    ...
    public function adminmessages()
    {
            ...
            return view('seller.ticket.index',compact('convs'));            
    }
    ...
    public function adminDiscordmessages()
    {
            ...
            return view('seller.dispute.index',compact('convs'));            
    }
    ...
    {
            $conv = AdminUserConversation::findOrfail($id);
            return view('seller.ticket.create',compact('conv'));                 
    }   
